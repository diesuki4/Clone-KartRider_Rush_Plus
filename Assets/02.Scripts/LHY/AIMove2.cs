...
public class AIMove2 : MonoBehaviour
{
    ...
    public static AIMove2 Instance;
    ...
    private void Update()
    {
        ...
        if (GameManager.Instance.finishCount >= 17)
        {
            ...
            if (thisaic >= 3)
            {
                ...
                thisai.GetComponent<AIMove2>().StopCoroutine("AI_Move");
            }
            if (stopCountDown >= 10)
            {
                if (thisaic < 3)
    ...
    public void StartAI()
    {
        ...
        //dir = Vector3.forward;
        target = GameManager.Instance.target2[nextTarget];   //���Ӹ޴����� ����ִ� Ÿ���� �迭�� ������ �ͼ� ����Ÿ���� Ÿ�ٿ� �����Ѵ�
    ...
    IEnumerator AI_Move()
    {
        ...
        while (true)
        {
            ...
            if (dis <= 30)
            {
                ...
                nextTarget += 1;
                if (nextTarget >= GameManager.Instance.target2.Length)
                    nextTarget = 0;


                target = GameManager.Instance.target2[nextTarget];
